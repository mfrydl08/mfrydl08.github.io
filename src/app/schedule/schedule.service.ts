...
export class ScheduleService {
  ...
  public getGamesBySelectedSessionValue(selectedSessionValue: string): Game[] {
    ...
    const gameData = [
      ...
      {homeTeam:"Point of Rocks", awayTeam:"Jolly Green Giants", field:"7A", gameDate: "09-29-2023", gameTime: "6:00", isScoreFinal: true, homeScore: 6, awayScore: 6, session: "2", week: 1, status: ""},
      ...
      {homeTeam:"KMP", awayTeam:"Internationals", field:"7A", gameDate: "09-29-2023", gameTime: "9:00", isScoreFinal: true, homeScore: 5, awayScore: 4, session: "2", week: 1, status: ""},
      {homeTeam:"Blue City", awayTeam:"Mustang", field:"7B", gameDate: "09-29-2023", gameTime: "8:00", isScoreFinal: false, homeScore: 8, awayScore: 4, session: "2", week: 1, status: ""},
      {homeTeam:"Absinthe Minded", awayTeam:"Agony of Da Feet", field:"7B", gameDate: "09-29-2023", gameTime: "9:00", isScoreFinal: false, homeScore: 2, awayScore: 3, session: "2", week: 1, status: ""},
