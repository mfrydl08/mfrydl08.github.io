...
export class ScheduleService {
  ...
  public getGamesBySelectedSessionValue(selectedSessionValue: string): Game[] {
    ...
    const gameData = [
      ...
      {homeTeam:"Mustangs FC", awayTeam:"Internationals", field:"6A", gameDate: "08-25-2023", gameTime: "6:00", isScoreFinal: false, homeScore: 0, awayScore: 0, session: "1", week: 4, status: "Rescheduled"},
      {homeTeam:"Roadkill", awayTeam:"Agony of Da Feet", field:"7A", gameDate: "08-25-2023", gameTime: "6:00", isScoreFinal: false, homeScore: 0, awayScore: 0, session: "1", week: 4, status: "Rescheduled"},
      {homeTeam:"Absinthe Minded", awayTeam:"Jolly Green Giants", field:"6A", gameDate: "08-25-2023", gameTime: "7:00", isScoreFinal: false, homeScore: 0, awayScore: 0, session: "1", week: 4, status: "Rescheduled"},
