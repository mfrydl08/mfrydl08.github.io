...
export class ScheduleService {
  ...
  public getGamesBySelectedSessionValue(selectedSessionValue: string): Game[] {
    ...
    const gameData = [
      ...
      {homeTeam:"Utica United", awayTeam:"KMP", field:"6A", gameDate: "05-10-2024", gameTime: "7:00", isScoreFinal: true, homeScore: 7, awayScore: 4, session: "3", week: 6, status: "", division: "1"},
      {homeTeam:"Frederick Aces", awayTeam:"Blue City", field:"6B", gameDate: "05-10-2024", gameTime: "7:00", isScoreFinal: true, homeScore: 4, awayScore: 7, session: "3", week: 6, status: "", division: "1"},
      {homeTeam:"Agony of Da Feet", awayTeam:"Jolly Green Giants", field:"6A", gameDate: "05-10-2024", gameTime: "8:00", isScoreFinal: true, homeScore: 7, awayScore: 4, session: "3", week: 6, status: "", division: "1"},
      {homeTeam:"Roadkill", awayTeam:"Caballos", field:"6B", gameDate: "05-10-2024", gameTime: "8:00", isScoreFinal: true, homeScore: 3, awayScore: 7, session: "3", week: 6, status: "", division: "1"},
      {homeTeam:"PORC Point of Rocks Crew", awayTeam:"Rusty Knights", field:"6A", gameDate: "05-10-2024", gameTime: "9:00", isScoreFinal: true, homeScore: 7, awayScore: 4, session: "3", week: 6, status: "", division: "1"},
      {homeTeam:"Roadkill", awayTeam:"Internationals", field:"6B", gameDate: "05-10-2024", gameTime: "9:00", isScoreFinal: true, homeScore: 3, awayScore: 5, session: "3", week: 6, status: "", division: "1"},
